...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.new_question = {"question": "Who invented Peanut Butter?", "difficulty": 2, "answer": "George Washington Carver", "category": 4}
    def tearDown(self):
    ...
    def test_get_question_search_with_results(self):
        res = self.client().post("/question", json={"searchTerm": "Tom"})
        data = json.loads(res.data)
    ...
    def test_get_question_search_without_results(self):
        res = self.client().post("/questions", json={"search": "mariana"})
        data = json.loads(res.data)
